...
def test_get_vertex(arango_db): # TODO NOW update for multiple
    """
    ...
    ret = att.get_vertices(['bar'], 201).get('bar')
...
def test_get_edge(arango_db): # TODO NOW update for multiple edges
    """
    ...
    ret = att.get_edges(['bar'], 201).get('bar')
